<div id="about" class="min-h-screen text-base-content px-6 md:px-20 pt-16">
	<div class="max-w-7xl mx-auto space-y-10">
		<div class="text-center space-y-4">
			...
			<p class="text-base text-base-content/80 max-w-3xl mx-auto mt-10">
		...
		<div class="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
			...
			<div class="lg:col-span-3 space-y-6 text-center lg:text-left">
				<h2 class="text-2xl md:text-3xl font-bold font-display">What is MoraXtreme?</h2>
				...
				<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-center text-sm mt-12">
