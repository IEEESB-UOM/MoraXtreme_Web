<section id="about" class="text-base-content px-6 md:px-20 min-h-screen flex items-center justify-center relative">
	<div class="max-w-7xl mx-auto">
		...
		<div class="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center my-16">
